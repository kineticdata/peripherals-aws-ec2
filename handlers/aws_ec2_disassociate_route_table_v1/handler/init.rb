...
class AwsEc2DisassociateRouteTableV1
  ...
  def execute()
    resp = @ec2.disassociate_route_table(
      dry_run: @parameters['dry_run'],
      association_id: @parameters['association_id']
    )

    puts "The route table has been detached from the subnet." if @enable_debug_logging
