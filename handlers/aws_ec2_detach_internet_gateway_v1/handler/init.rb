...
class AwsEc2DetachInternetGatewayV1
  ...
  def execute()
    ...
    puts "Internet Gateway #{@parameters['internet_gateway_id']} successfully detached from VPC '#{@parameters['vpc_id']}'." if @enable_debug_logging
